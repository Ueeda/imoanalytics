...
namespace ImoAnalyticsSystem.ViewModels.IdentityViewModels
{
    ...
    public class ChangePasswordViewModel
    {
        ...
        [Required]
        [StringLength(100, ErrorMessage = "A senha precisa ter ao mínimo 6 caracteres.", MinimumLength = 6)]
        [DataType(DataType.Password)]
        ...
        [Compare("NewPassword", ErrorMessage = "A senha e a confirmação da nova senha não são iguais.")]
        public string ConfirmPassword { get; set; }
    }
